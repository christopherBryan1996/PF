    ...
    <Router>
      <div>
        <Switch>
          ...
          <PublicRoute exact path="/home" component={HomePrueba} />
          <PublicRoute exact path="/homePrueba" component={Home} />
          ...
          <PublicRoute
            exact
            path="/home/:username/favorites"
            // isAuthenticated={isAuthenticated}
            component={Favorites}
          />
          <PublicRoute exact path="/home/favorites" component={FavoritesInv} />
          {/* ruta para modificar usuario */}
          <PrivateRoute
            exact
          ...
          <PrivateRoute
            exact
            path="/asistentes/:uid/:eventid"
            isAuthenticated={isAuthenticated}
            component={AsistentesPage}
          />
          <PrivateRoute
            exact
            path="/modificarEventos/:eventid"
            isAuthenticated={isAuthenticated}
